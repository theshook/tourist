...
router.post('/image/:spot_no', isLoggedIn, upload.array('image[]', 5),spotController.spots_save_image);

// Set Location
router.get('/location/:spot_no', isLoggedIn, spotController.spots_set_location);
router.post('/location/:spot_no', isLoggedIn, spotController.spots_save_location);
